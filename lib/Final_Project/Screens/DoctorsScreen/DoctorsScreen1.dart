...
class DoctorsScreen1 extends  StatefulWidget {
  const DoctorsScreen1({super.key});

  @override
  State<DoctorsScreen1> createState() => _DoctorsScreen1State();
}

class _DoctorsScreen1State extends State<DoctorsScreen1> {
  @override
            ...
            children: [
              Row(
                ...
                [
                  ...
                  SizedBox(width: 110,),
                  Center(child: Text(' Covid 19 Doctors ' ,style: TextStyle(color: Colors.teal ,fontSize: 20 ,fontWeight: FontWeight.bold),))
                ],
              ),
              Center(
                child: Column(
